...
private int curPage;	//현재 페이지 번호
	...
	//총 게시글 수를 입력하는 생성자
	public Paging_board(int totalCount) {
	...
	public Paging_board(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public Paging_board(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public Paging_board(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
