...
<div id="wrap-box-top">
	<div><a href="/admin/index"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;관리자 홈</a></div>
...
<div id="wrap-box">
 ...
 <ul class="orderList">
  ...
  <div class="thumb">
   ...
   <p><span>주문번호</span><a href="/admin/goods/orderView?n=${orderList.orderId}">${orderList.orderId}</a></p>
   
   <p><span>회원번호</span>${orderList.memberNo}</p>
