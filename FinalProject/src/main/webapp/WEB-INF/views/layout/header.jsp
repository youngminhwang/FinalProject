...
<script type="text/javascript"><!-- 네이버 로그아웃 관련 script -->
var testPopUp;
	...
	<div id="header-box">
		...
		<div>
			...
			<div class="header-login-box">
				...
				<c:choose>
					<c:when test="${loginType eq 1 || loginType eq 2 || loginType eq 3 }">
						<a href="/member/test"><span class="header-menu-text-xs">내정보</span></a>
					</c:when>
				</c:choose>
