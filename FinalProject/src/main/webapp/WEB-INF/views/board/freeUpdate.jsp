...
<div class="form-group">
	...
	<input type="text" id="title" name="btitle" class="form-control" value="${updateFreeBoard.btitle }">
</div>
<div class="form-group">
	<label for="content">본문</label>
	<textarea rows="10" style="width: 100%;" id="content" name="bcontent">${updateFreeBoard.bcontent }</textarea>
</div>
...
<div class="form-group">
	...
	<div id="filebox">
		...
		<div id="newFile">
			...
			<small>새로운 파일을 첨부하면 기존 파일은 삭제됩니다</small>
		</div>
